import {SHOW_GAME_MESSAGE, HIDE_GAME_MESSAGE, ANALYZE_CHOICE, RESTART_GAME} from "./action"
...
export default function reducer(state=initialState, action)  {
  ...
  if(action.type === "SHOW_GAME_MESSAGE") {
    ...
    return Object.assign({}, state, {
      ...
      hotOrColdMessage: showResultsMessage(action.userInput, state=initialState)
   })
